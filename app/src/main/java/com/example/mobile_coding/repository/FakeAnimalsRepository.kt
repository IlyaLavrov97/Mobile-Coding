    ...
    override fun getAnimals(): List<Animal> {
        return ArrayList<Animal>().apply {
            for (i in 0 until 20) {
                when {
                    i % 3 == 0 -> {
                        add(Cat("cat" + Random.nextInt(i, 100).toString(), Random.nextInt(i, 100)))
                    }
                    i % 3 == 1 -> {
                        add(Dog("dog" + Random.nextInt(i, 30).toString(), Random.nextInt(i, 20)))
                    }
                    i % 3 == 2 -> {
                        add(Parrot("parrot" + Random.nextInt(i, 30).toString(), Random.nextInt(i, 20)))
                    }
                }
            }
        }
